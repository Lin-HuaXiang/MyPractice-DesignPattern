...
public class QuestionBankController {
    ...
    public String createPager(String candidate, String number) {
        ...
        choiceQuestionList.add(new ChoiceQuestion("下列列说法正确的是", map02, "A"));
        choiceQuestionList.add(new ChoiceQuestion("变量量命名规范说法正确的是", map03, "B"));
        choiceQuestionList.add(new ChoiceQuestion("以下()不不是合法的标识符", map04, "C"));
